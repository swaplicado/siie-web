	...
	<div class="row">
	  <div class="col-md-6">
			...
			<div class="form-group">
				...
				{!! Form::text('name',
					isset($gender) ? $gender->name : null , ['class'=>'form-control', 'maxlength' => '100',
	  ...
	  <div class="col-md-6">
			...
			<div class="form-group">
				...
				<select class='form-control' name="item_type_id" id="item_type_id" required value="{{ isset($gender) ?  $gender->item_type_id : null }}">
					@if (isset($gender))
