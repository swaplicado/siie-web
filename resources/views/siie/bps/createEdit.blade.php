...
@section('content')
		...
		<div class="form-group">
			...
			{!! Form::text('name',
				isset($bpartner) ? $bpartner->name : null , ['class'=>'form-control', 'onKeyup' => 'javascript:this.value=this.value.toUpperCase();',
		...
		<div class="form-group">
			...
			{!! Form::text('last_name',
				isset($bpartner) ? $bpartner->last_name : null , ['class'=>'form-control', 'onKeyup' => 'javascript:this.value=this.value.toUpperCase();',
		...
		<div class="form-group">
			...
			{!! Form::text('first_name',
				isset($bpartner) ? $bpartner->first_name : null , ['class'=>'form-control', 'onKeyup' => 'javascript:this.value=this.value.toUpperCase();',
		...
		<div class="form-group">
			...
			{!! Form::text('fiscal_id',
				isset($bpartner) ? $bpartner->fiscal_id : null , ['class'=>'form-control', 'onKeyup' => 'javascript:this.value=this.value.toUpperCase();',
		...
		<div class="form-group">
			...
			{!! Form::text('person_id',
				isset($bpartner) ? $bpartner->person_id : null , ['class'=>'form-control', 'onKeyup' => 'javascript:this.value=this.value.toUpperCase();',
