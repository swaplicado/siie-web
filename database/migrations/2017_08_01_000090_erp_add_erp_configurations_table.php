    ...
    public function up()
    {
        foreach ($this->lDatabases as $base) {
          ...
          DB::connection($this->sConnection)->table('erp_configuration')->insert([
            ...
            ['id_configuration' => '9','code' => '009','name' => 'ALMACÉN MERCANCÍAS EN TRÁNSITO','val_boolean' => '0','val_int' => '2','val_text' => ' ','val_decimal' => '0', 'is_deleted' => '0', 'created_by_id' => '1', 'updated_by_id' => '1'],
