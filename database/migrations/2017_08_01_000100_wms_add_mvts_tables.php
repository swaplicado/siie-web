    ...
    public function up()
    {
        foreach ($this->lDatabases as $base) {
          ...
          Schema::connection($this->sConnection)->create('wmss_mvt_types', function (blueprint $table) {
          	...
          	$table->foreign('class_id')->references('id_class')->on('wmss_mvt_classes')->onDelete('cascade');
          });
          ...
          DB::connection($this->sConnection)->table('wmss_mvt_trn_types')->insert([
          	...
          	['id_type' => '2','code' => 'SD','name' => 'SURTIDO/DEVOLUCIÓN','is_deleted' => '0'],
          	['id_type' => '3','code' => 'CAM','name' => 'CAMBIO','is_deleted' => '0'],
          	['id_type' => '4','code' => 'GAR','name' => 'GARANTÍA','is_deleted' => '0'],
          	['id_type' => '5','code' => 'CON','name' => 'CONSIGNACIÓN','is_deleted' => '0'],
          ]);
          ...
          DB::connection($this->sConnection)->table('wmss_mvt_mfg_types')->insert([
          	['id_type' => '1','code' => 'NA','name' => 'N/A','is_deleted' => '0'],
          	['id_type' => '2','code' => 'MAT','name' => 'MATERIALES','is_deleted' => '0'],
          	['id_type' => '3','code' => 'PRO','name' => 'PRODUCTO','is_deleted' => '0'],
          ]);
          ...
          DB::connection($this->sConnection)->table('wmss_mvt_adj_types')->insert([
          	['id_type' => '1','code' => 'NA','name' => 'N/A','is_deleted' => '0'],
          	['id_type' => '2','code' => 'IIF','name' => 'INVENTARIO (INICIAL Y FINAL)','is_deleted' => '1'],
          	['id_type' => '3','code' => 'CPI','name' => 'CORRECCIÓN POR DISCREPANCIA','is_deleted' => '2'],
          	['id_type' => '4','code' => 'CPE','name' => 'CORRECCIÓN POR EQUIVOCACIÓN','is_deleted' => '3'],
          	['id_type' => '5','code' => 'DPO','name' => 'DEPOSICIÓN POR OBSOLESCENCIA','is_deleted' => '4'],
          	['id_type' => '6','code' => 'DPC','name' => 'DEPOSICIÓN POR CADUCIDAD','is_deleted' => '5'],
          	['id_type' => '7','code' => 'DPD','name' => 'DEPOSICIÓN POR DAÑO','is_deleted' => '6'],
          	['id_type' => '8','code' => 'MCO','name' => 'MUESTRA COMERCIAL','is_deleted' => '7'],
          	['id_type' => '9','code' => 'MPR','name' => 'MUESTRA PROMOCIONAL','is_deleted' => '8'],
          	['id_type' => '10','code' => 'IYD','name' => 'INVESTIGACIÓN Y DESARROLLO','is_deleted' => '9'],
          	['id_type' => '11','code' => 'LAB','name' => 'LABORATORIO','is_deleted' => '10'],
          	['id_type' => '12','code' => 'DEG','name' => 'DEGUSTACIÓN','is_deleted' => '11'],
          	['id_type' => '13','code' => 'DON','name' => 'DONACIÓN','is_deleted' => '12'],
          	['id_type' => '14','code' => 'OTR','name' => 'OTROS','is_deleted' => '13'],
          ]);
