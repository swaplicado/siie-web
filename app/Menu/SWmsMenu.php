      ...
      return \Menu::new()
        ...
        ->submenu(
            ...
            \Menu::new()
                ...
                ->route('wms.movs.create', trans('wms.MOV_WHS_TRS_OUT'), [\Config::get('scwms.MVT_TP_OUT_TRA'), trans('wms.MOV_WHS_TRS_OUT')])
                // ->route('wms.movs.create', trans('wms.MOV_WHS_PUR_IN'), [\Config::get('scwms.MVT_TP_IN_PUR'), trans('wms.MOV_WHS_PUR_IN')])
