...
oTransfersMovsTable = $('#transfers_table').DataTable({
      "language": {
        "sProcessing":     "Procesando...",
        "sLengthMenu":     "Mostrar _MENU_ registros",
        "sZeroRecords":    "No se encontraron resultados",
      ...
      "columnDefs": [
        {
            "targets": [7,8], // your case first column
            "className": "text-right"
        },
        {
            "targets": [1,3,4,5,6,9,10], // your case first column
            "className": "text-center"
        },
        {
            "targets": 1, // your case first column
  ...
  oTransfersMovsTable.column( 0 ).visible( false );

  $('#transfers_table tbody').on( 'click', 'tr', function () {
      if ( $(this).hasClass('selected') ) {
          $(this).removeClass('selected');
      }
      else {
          oTransfersMovsTable.$('tr.selected').removeClass('selected');
          $(this).addClass('selected');
      }
  });
...
oPalletTable = $('#pallet_table').DataTable({
      "paging": false,
      "language": {
        "sProcessing":     "Procesando...",
        "sLengthMenu":     "Mostrar _MENU_ registros",
  ...
  oPalletTable.column( 0 ).visible( false );
